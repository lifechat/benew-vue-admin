...
const isActive = (v: RouteItem) => {
	if (getThemeConfig.value.isShareTagsView) {
		...
		if ((v.query && Object.keys(v.query).length) || (v.params && Object.keys(v.params).length)) {
			...
			// https://gitee.com/lifechat/benew-vue-admin/issues/I51RS9
			return v.path === state.routePath;
		}
	}
};
...
// https://gitee.com/lifechat/benew-vue-admin/issues/I61VS9
...
// https://gitee.com/lifechat/benew-vue-admin/issues/I5K3YO
// https://gitee.com/lifechat/benew-vue-admin/issues/I61VS9
...
// 拖动问题，https://gitee.com/lifechat/benew-vue-admin/issues/I3ZRRI
